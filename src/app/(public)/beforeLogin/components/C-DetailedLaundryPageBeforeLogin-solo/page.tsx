...
import ExclamationMark from "@/assets/icons/main/exclamation.svg"; // Assuming you have an exclamation mark icon
...
const InactiveLaundryPage = () => {
	...
	return (
		<div className="p-3 bg-white w-[290px] h-auto rounded-md border relative mb-[20px]">
			...
			{/* Overlay */}
			<div className="absolute inset-0 bg-black bg-opacity-60 flex flex-col items-center justify-center rounded-md backdrop-blur-sm z-40">
				<ExclamationMark />
				<div className=" text-white mt-[12px]  mb-[12px] text-center whitespace-pre-line ">
					아직 주변에 모집 중인 알뜰 세탁이 없어요.{"\n"}모집을 시작해보세요!
				</div>
				<CTAButtonSmall
					buttonColor="#13C2C2"
					borderColor="#13C2C2"
					...
					buttonText="모집 시작"
					buttonTextSize="16px"
					buttonTextColor="#FFFFFF"// Add onClick handler here
				/>
			</div>
		</div>
	);
