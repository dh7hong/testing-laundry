...
const MapWithSearch: React.FC = () => {
  ...
  const [selectedAddressGPS, setSelectedAddressGPS] = useState<{ latitude: number; longitude: number } | null>(null);
    ...
    <div>
      <div className="flex flex-col items-center">
        <div className="w-full max-w-[430px] bg-static-white flex flex-col pt-[5px]">
          <TopNavigation text="지도로 세탁소 보기" onClick={handleBackNavigation}></TopNavigation>
        </div>
      </div>
